 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'img/openlayer/'; //图片路径配置
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" class="buttonStyle" value="Close" id="_ButtonOK_' + this.ID + '"/>\
                <input type="hidden" class="buttonStyle" value="Close" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
...
Dialog.prototype.show = function () {
    ...
    var bgdiv = Dialog.getBgdiv(),
		thisdialogDiv=this.getDialogDiv();
    this.zindex = thisdialogDiv.style.zIndex = 20;//Dialog.bgDiv.style.zIndex + 1;
    thisdialogDiv.style.zIndex =60;
